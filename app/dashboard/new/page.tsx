    ...
    <div className="w-full h-full flex flex-1 items-center justify-center">
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Create new appoinment type that allows people to book you!
          </CardDescription>
        </CardHeader>
          ...
          <CardContent className="grid gap-y-5">
            ...
            <div className="flex flex-col gap-y-2">
              ...
              <div className=" flex rounded-md">
                <span className="inline-flex items-center px-3 rounded-l-md border border-r-0 border-muted text-sm text-muted-foreground">
                  calendryl.com
                </span>
                <Input
